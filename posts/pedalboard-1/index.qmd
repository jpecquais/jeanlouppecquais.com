...
![Implémentation d'un amplificateur "virtuel", avec une entrée mono, et une sortie stéréo, induite par la simulation de haut-parleur rotatif.](ressources/amp_section.svg)
...
![Chemin du signal global](ressources/global_chain.svg)
...
![Chemin du signal de la section pre amplification.](ressources/pre_amp_chain.svg)
...
En fonction du type de son à réaliser avec cette sortie auxiliaire, il est possible de prélever le signal à deux points différents dans le chemin du signal, soit directement à l'entré, soit au niveau de l'amplificateur. En pratique, il est nécessaire d'avoir un signal très propre pour pouvoir correctement le transformer en son synthétique. A l'inverse, pour certains effets de granulaire, ou d'ambiant, il est plus intéressant d'avoir accès à son plus proche d'un son de guitare électrique usuel.
